...
import { Text, ProgressBar, Heading, Stack, Button, Inline, Lozenge, Toggle, Tooltip, Modal, ModalHeader, ModalTitle, ModalBody, ModalFooter, TextArea, SectionMessage } from '@forge/react';
import { invoke } from '@forge/bridge';

export const ProfiloView = () => {
            ...
            {data.allSfide
              ...
              .map(sfida => (
                <Inline key={sfida.key} space="space.100" alignBlock="center">
                  ...
                  {sfida.custom && <Lozenge appearance="new">✨ Custom</Lozenge>}
                </Inline>
              ))}
          </Stack>
