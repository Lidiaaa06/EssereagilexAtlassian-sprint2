...
export const applicaCambioPosizione = async (classificaOrdinata, chiaveSnapshot = 'classifica-snapshot') => {
  const snapshot = await kvs.get(chiaveSnapshot);
